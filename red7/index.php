	...
	<amp-story standalone canShowSystemLayerButtons="false" title="Very" publisher="Main Street">		
		...
		<amp-story-page id="page1-1">
			<amp-story-grid-layer template="fill">
				<amp-img src="./assets/page-1-1-bg.jpg"
					width="320"
					height="640"
					layout="responsive"
					alt="">
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title page-title_primary" style="margin: 0 0 2vh;">
						<span>Особый</span>
						<span style="align-self: flex-end;">статус</span>
					</h1>
					<p class="page-text">
						Клубный дом в&nbsp;историческом центре Москвы на&nbsp;пересечении <span style="color: #E40613;">Садового кольца</span> и&nbsp;проспекта Сахарова. 
					</p>						
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
		...
		<amp-story-page id="page1-2">
			<amp-story-grid-layer template="fill">
				<amp-img src="./assets/page-1-2-bg.png"
					width="320"
					height="640"
					layout="responsive"
					alt="">
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page1-3'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Окружение
					<amp-img src="./assets/arrow-right.svg"
						width="30"
						height="7"						
			...
			<amp-story-grid-layer template="vertical" class="content-layer" style="padding-top: 70px;">
				<div>
					<h1 class="page-title" style="margin: 0 0 2vh;">
						<span>Живите в центре</span>
						<span style="align-self: flex-end;">событий</span>
					</h1>										
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
		...
		<amp-story-page id="page1-3">
			...
			<amp-story-grid-layer template="vertical" class="content-layer" style="padding-left: 20px; padding-right: 20px;">
				<div>
					<h1 class="page-title" style="margin: 0 0 4vh;">
						<span>В шаговой</span>
						<span style="align-self: flex-end;">доступности</span>
					</h1>					
					<div class="slider swiper" style="padding-left: 30px;">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img src="./assets/slider/slider-img-1.jpg" width="282" height="174" alt="">
								<span>
									Исторический<br>центр								
								</span>
							</div>
							<div class="swiper-slide">
								<img src="./assets/slider/slider-img-2.jpg" width="228" height="300" alt="">
								<span>
									Рестораны<br>и кафе								
								</span>
							</div>													
							<div class="swiper-slide">
								<img src="./assets/slider/slider-img-3.jpg" width="282" height="174" alt="">
								<span>
									Музеи
								</span>
							</div>													
							<div class="swiper-slide">
								<img src="./assets/slider/slider-img-4.jpg" width="228" height="300" alt="">
								<span>
									Престижные<br>университеты<br>и школы
								</span>
							</div>													
							<div class="swiper-slide">
								<img src="./assets/slider/slider-img-5.jpg" width="282" height="174" alt="">
								<span>
									Медицинские<br>центры
								</span>
							</div>																										
						</div>
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title" style="margin: 0 0 2vh;">
						...
						<span style="align-self: flex-end;">доступность</span>
					</h1>
					<div class="page-1-4-content">
						<div class="page-1-4-content__item" style="padding-bottom: 18px;">
							<div class="page-1-4-content__item-img">
								<amp-img src="./assets/page-1-4-1.svg"
									width="35"
									height="14"									
									alt="">
								</amp-img>
							...
							<div class="page-1-4-content__text">
								<p>
									<span><b>Садовое кольцо</b></span>
									<span>прямой выезд из паркинга</span>
								</p>
								<p>
									<span><b>Бульварное кольцо</b></span>
									<span>3 минуты</span>
								</p>
								<p>
									<span><b>ТТК</b></span>
						...
						<div class="page-1-4-content__item" style="padding: 15px 0;">
							<div class="page-1-4-content__item-img">
								<amp-img src="./assets/page-1-4-2.png"
									width="27"
									height="18"									
									alt="">
								</amp-img>
							...
							<div class="page-1-4-content__text">
								<p>
									<span><b>Красные ворота</b></span>
									<span>7 мин</span>
								</p>
								<p>
									<span><b>Сухаревская</b></span>
									<span>9 мин</span>
								</p>							
							</div>
						</div>
						<div class="page-1-4-content__item" style="padding-top: 15px;">
							<div class="page-1-4-content__item-img">
								<amp-img src="./assets/page-1-4-3.svg"
									width="24"
									height="20"									
									alt="">
								</amp-img>
							...
							<div class="page-1-4-content__text">
								<p>
									<span><b>Площадь 3-х вокзалов</b></span>
