	...
	<amp-story standalone canShowSystemLayerButtons="false" title="Very" publisher="Main Street">
		...
		<amp-story-page id="page2-1">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page2-2'" class="btn" grid-area="lower-third" style="margin-top: auto;">
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title" style="margin: 0 0 18px;">
						...
						<span style="align-self: flex-end;">сервисы дома</span>
					</h1>
					<div class="page-2-1-content">
						<div class="page-2-1-content__block">
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-1.svg"
										width="17"
										height="17"										
										alt="">
									</amp-img>
								</div>
								<span>собственный бассейн<br>25 м</span>
							</div>
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-2.svg"
										width="22"
										height="22"										
										alt="">
									</amp-img>
						...
						<div class="page-2-1-content__block">
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-3.svg"
										width="23"
										height="19"										
										alt="">
									</amp-img>
								...
								<span>
									персональные столы<br>в ресторане на 1-м этаже
								</span>
							</div>
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-4.svg"
										width="23"
										height="23"										
										alt="">
									</amp-img>
						...
						<div class="page-2-1-content__block">
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-5.svg"
										width="23"
										height="23"										
										alt="">
									</amp-img>
							...
							<div class="page-2-1-content__item">
								<div class="page-2-1-content__img">
									<amp-img src="./assets/page-2-1-icons/icon-6.svg"
										width="19"
										height="19"										
										alt="">
									</amp-img>
		...
		<amp-story-page id="page2-2">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page2-3'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Открытая терраса
					<amp-img src="./assets/arrow-right.svg"
						width="30"
						height="7"						
			...
			<amp-story-grid-layer template="vertical" class="content-layer" style="padding-top: 0;">
				<div class="page-2-2-content">
					<h1 class="page-title" style="display: flex; flex-direction: column; align-items: center; text-align: center; margin: 0 0 36px;">
						Клубные<br>пространства<br>для резидентов
					</h1>
					<p class="page-text" style="text-align: center;">
						Принимайте гостей, проводите семейные торжества или устраивайте вечеринки с&nbsp;друзьями на&nbsp;клубной террасе для резидентов 
					</p>
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>		
		...
		<amp-story-page id="page2-3">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page2-4'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Закрытое лаунж пространство
					<amp-img src="./assets/arrow-right.svg"
						width="30"
						height="7"						
						alt="">
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title story-2-title">
						<span>Открытая терраса</span>
						<span style="align-self: flex-end;">1000 М<sup>2</sup></span>
					</h1>
					<div class="image-block">
						<amp-img src="./assets/page-2-3-image.jpg"
							width="360"
							height="232"
							layout="responsive"
							alt="">
					...
					<p class="page-text">
						Насладитесь видом на&nbsp;центр города на&nbsp;открытой террасе, где приятно выпить чашку кофе с&nbsp;утра или бокал вина на&nbsp;закате
					</p>
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
		...
		<amp-story-page id="page2-4">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page2-5'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Кинотеатр
					<amp-img src="./assets/arrow-right.svg"
						width="30"
						height="7"						
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title story-2-title">
						<span>Закрытое лаунж</span>
						<span style="align-self: flex-end;">пространство</span>
					</h1>
					<div class="image-block">
						<amp-img src="./assets/page-2-4-image.jpg"
							width="360"
							height="232"
							layout="responsive"
							alt="">
					...
					<ul class="marked-list">
						<li>место для релакса у&nbsp;камина</li>
						<li>большую кухню-гостиную для проведения различных мероприятий и&nbsp;мастер-классов</li>
						<li>кинотеатр, который трансформируется в&nbsp;детскую комнату</li>
					</ul>
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
		...
		<amp-story-page id="page2-5">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='#page=page2-6'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Коворкинг
					<amp-img src="./assets/arrow-right.svg"
						width="30"
						height="7"						
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title story-2-title">
						<span>Кинотеатр</span>
						<span style="align-self: flex-end;">для резидентов</span>
					</h1>
					<div class="image-block">
						<amp-img src="./assets/page-2-5-image.jpg"
							width="360"
							height="232"
							layout="responsive"
							alt="">
					...
					<ul class="marked-list">
						<li>Смотрите с&nbsp;друзьями любимые фильмы и&nbsp;сериалы в&nbsp;клубном кинотеатре</li>
						<li>Приватное пространство не&nbsp;более чем для 20&nbsp;киноманов</li>
						<li>Клубный кинотеатр также можно использовать в&nbsp;качестве детской игровой</li>
					</ul>
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
		...
		<amp-story-page id="page2-6">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='form.php'" class="btn sidebar-control" grid-area="lower-third" style="margin-top: auto;">
					Записаться на показ					
				</a>
			</amp-story-grid-layer>
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title story-2-title" style="margin-bottom: 80px;">
						Коворкинг
					</h1>
					<div class="image-block">
						<amp-img src="./assets/page-2-6-image.jpg"
							width="360"
							height="232"
							layout="responsive"
							alt="">
					...
					<p class="page-text">
						Удобное пространство для работы, проведения переговоров и&nbsp;деловых встреч с&nbsp;видом на&nbsp;Садовое кольцо и&nbsp;центр Москвы
					</p>
				</div>				
			</amp-story-grid-layer>
		</amp-story-page>	
