...
<body>
	<amp-story standalone canShowSystemLayerButtons="false" title="Very" publisher="Main Street">
		...
		<amp-story-page id="page1-1">
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='./index.php#page=page1-2'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Парки рядом
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title">
						Шикарный вид<br>на день
					</h1>
					<p class="page-text">
						Из панорамных окон открываются удивительной красоты виды на зелень парков и город.
					</p>
					<div class="slider swiper">
						<div class="swiper-wrapper">
							<img class="swiper-slide"
								src="./assets/slider-images/image-1.jpg"								
								width="720"
								height="470"								
								alt="">							
							<img class="swiper-slide"
								src="./assets/slider-images/image-2.jpg"								
								width="720"
								height="470"								
								alt="">							
							<img class="swiper-slide"
								src="./assets/slider-images/image-3.jpg"								
								width="720"
								height="470"								
								alt="">							
							<img class="swiper-slide"
								src="./assets/slider-images/image-4.jpg"								
								width="720"
								height="470"								
								alt="">							
							<img class="swiper-slide"
								src="./assets/slider-images/image-5.jpg"								
								width="720"
								height="470"								
								alt="">							
						</div>
						<div class="slider__navigation">
							<div class="slider__controls">
                                <a role="button" class="slider__control swiper-button-prev"></a>
    							<a role="button" class="slider__control swiper-button-next"></a>
							</div>
		...
		<amp-story-page id="page1-2">
			<amp-story-grid-layer template="fill">
				<amp-img src="./assets/page-1-2-bg.jpg"
					width="320"
					height="640"
					layout="responsive"
					alt="">
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='./index.php#page=page1-3'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Зеленый двор
					<amp-img src="./assets/arrow-right.svg"
						width="24"
						height="18"						
			...
			<amp-story-grid-layer template="vertical" class="content-layer">
				<div>
					<h1 class="page-title">
						Окружите себя<br>природой
					</h1>
					<p class="page-text">
						600 гектаров прогулочных зон в шаговой доступности.
					</p>
					<div class="parks-list">
						<div class="parks-list__item">
							<img src="./assets/time-icons/2-mins.png" width="45" height="47" alt="">
							<span>Ботанический сад</span>
						</div>
						<div class="parks-list__item">
							<img src="./assets/time-icons/12-mins.png" width="45" height="47" alt="">
							<span>Мичуринский сад</span>
						</div>
						<div class="parks-list__item">
							<img src="./assets/time-icons/13-mins.png" width="45" height="47" alt="">
							<span>Парк “Сад будущего”</span>
						</div>
						<div class="parks-list__item">
							<img src="./assets/time-icons/14-mins.png" width="45" height="47" alt="">
							<span>Леоновская роща</span>
						</div>
						<div class="parks-list__item">
							<img src="./assets/time-icons/15-mins.png" width="45" height="47" alt="">
							<span>Парк Останкино</span>
						</div>
						<div class="parks-list__item">
							<img src="./assets/time-icons/25-mins.png" width="45" height="47" alt="">
							<span>Парк ВДНХ</span>
						</div>
					</div>		
				</div>				
		...
		<amp-story-page id="page1-3">			
			...
			<amp-story-grid-layer template="thirds" class="cta-layer">
				<a role="button" onclick="window.location='./index.php#page=page1-4'" class="btn" grid-area="lower-third" style="margin-top: auto;">
					Спорт на свежем воздухе					
				</a>
			</amp-story-grid-layer>
			<amp-story-grid-layer template="vertical" class="page-1-3-bg">
				<amp-img src="./assets/page-1-3-bg.jpg"
					width="720"
					height="520"
					layout="responsive"
					alt="">
				</amp-img>				
				<p class="page-1-3-content page-text">
					На территории квартала высажено более тысячи деревьев и кустарников для создания уникальной среды.
				</p>					
			</amp-story-grid-layer>			
		</amp-story-page>	

		<!-- PAGE 4 -->
		<amp-story-page id="page1-4">			
			<amp-story-grid-layer template="vertical" class="logo-layer">
				<amp-img src="./assets/very-logo.svg"
					width="89"
					height="23"					
			...
			<amp-story-grid-layer template="vertical" class="page-1-4-bg">
				<amp-img src="./assets/page-1-4-bg.jpg"
					width="600"
					height="842"
					layout="responsive"
					alt="">
			...
			<amp-story-grid-layer template="thirds" class="page-1-4-gradient">
				<amp-img grid-area="lower-third" src="./assets/page-1-4-gradient.png" style="margin: auto 0 0;"
					width="360"
					height="281"
					layout="responsive"
					alt="">
			...
			<amp-story-grid-layer template="thirds" class="page-1-4-layer">
				<div grid-area="lower-third" class="page-1-4-content">
					<h1 class="page-title">
						В режиме “лайт”
					</h1>
					<p class="page-text">
						Насладитесь аэробикой или йогой на свежем воздухе, велосипедными прогулками, голландской ходьбой или плаванием.
					</p>	
				</div>					
			</amp-story-grid-layer>
			<amp-story-grid-layer template="thirds" class="cta-layer">
  ...
  <script>
    ...
    <script type="text/javascript">
        var __cs = __cs || [];
        __cs.push(["setCsAccount", "fuzaZd5iGcR6yGlCh8lK0vGYPlg47fIW"]);
    </script>
